...
The extremal index \eqn{\theta} is a measure of the degree of local dependence in the extremes of a stationary process.  The `exdex` package performs frequentist inference about \eqn{\theta} using two types of methodology.  
