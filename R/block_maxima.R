...
#'   non-missing result.
#'
#'   \code{sliding_maxima} is used within \code{\link{spmax_mle}} to perform
...
#'
#'   \code{disjoint_maxima} is used within \code{\link{spmax_mle}} to perform
#'   semiparametric estimation of the extremal index based on block maxima.
#' @return A list containing
#'   \itemize{
...
#'   }
#' @seealso \code{\link{spmax_mle}} for semiparametric estimation of the
#'   extremal index based on block maxima.
