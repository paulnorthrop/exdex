...
#		ifelse(par>=1,0,-I(Ck==0)/(1-par))+2*I(Ck!=0)/par - Ck
	...
	Vn <- function(par, Ck, N0) {
	  print("ld")
	  print(length(ll.gap.score.i(par, Ck)))
	  print(summary(ll.gap.score.i(par, Ck)))
#	  print(ll.gap.score.i(par, Ck))
	  print(cbind(ll.gap.score.i(par, Ck), Ck, 2 / par - Ck,
	              ifelse(par>=1,0,-I(Ck==0)/(1-par))))
	  print("In")
	  print(In(par, Ck, N0))
	  print("Dnd")
	  print(Dpn(par, Ck, N0))
	  print("dc")
	  print(summary(2*I(Ck!=0)/par^2+Ck^2-4*Ck/par))
	  mean((2*I(Ck!=0)/par^2+Ck^2-4*Ck/par-
	...
	Tn <-function(par, Ck, N0){
	  print(Jn(par, Ck, N0)-In(par, Ck, N0))
	  print(Vn(par, Ck, N0))
